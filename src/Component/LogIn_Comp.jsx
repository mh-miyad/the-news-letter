...
const LogIn_Comp = () => {
 const [showPassword ,setShowPassword] =useState(false)
  ...
  <div>
    <p className='text-center my-4 font-bold text-gray-500'> New To News Site  <Link to={'/signup'}> <span className='mx-2 underline underline-offset-2 hover:text-blue-500 
    decoration-blue-700'> Please  Sign Up </span></Link>  </p>
  </div>
